...
export const metadata: Metadata = {
  title: "Nanjil Oasis Happy Centre | Special Needs Rehabilitation & Education",  description: "Compassionate special needs rehabilitation and education centre for children in India. Therapies, vocational training, and holistic support since 2009.",  keywords: "special needs, rehabilitation, education, children, therapy, autism, cerebral palsy",  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Nanjil Oasis Happy Centre - Empowering Every Child's Potential",    description: "Transforming challenges into achievements through holistic learning and compassionate care for children with special needs.",    siteName: "Nanjil Oasis Happy Centre",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/serious-primary-school-teacher-helping-girl-cope-with-her-task_74855-16455.jpg",        alt: "Children engaged in learning and therapeutic activities"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Nanjil Oasis Happy Centre",    description: "Special needs rehabilitation and education for children with compassion and expertise.",    images: ["http://img.b2bpic.net/free-photo/serious-primary-school-teacher-helping-girl-cope-with-her-task_74855-16455.jpg"]
  }
};
